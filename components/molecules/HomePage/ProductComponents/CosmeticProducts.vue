<template>
	<div>
		...
		data-aos-delay="200"
		>
		<div v-for="product in cosmetics.reverse()" :class="`${product.categories.map(d => d.name === 'Nutrisi' ? 'col-lg-4 portfolio-item filter-nutrisi' : 'col-lg-4 portfolio-item filter-kosmetik')}`">
				...
				<div class="portfolio-info">
					...
					<div class="portfolio-links mt-3">
						...
						><i class="bx bx-plus"></i
							></a>
							<nuxt-link
							:to="{name: `products-permalink`, params: {permalink: product.permalink}}"
