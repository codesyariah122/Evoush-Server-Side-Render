						...
						<div class="row justify-content-center interactive-product">
							<div class="col-lg-4">
								...
								<div v-if="loading">
									...
									<!-- <img src="https://chicagoboothangels.com/wp-content/themes/zerif-lite/images/DoubleRing.gif" class="img-fluid rotate loading-imgbox"> -->
...
<script>
	import { Logo }from '@/components/layouts/molecules'
